...
const POSTER_NAMES: Record<string, string> = {
  '01': "TECHVISION 2026 – ENGINEER'S DAY CELEBRATION & AWARDS",
  '02': 'IDEACANVAS – POSTER CHALLENGE',
  '03': 'INNOVATEX – SIH 2026 HACKATHON',
  '04': 'CODERUSH – COMPETITIVE PROGRAMMING CHALLENGE',
  '05': 'IIC IGNITE – INNOVATION & ENTREPRENEURSHIP AWARENESS CAMP',
  '06': 'TECHSPEAK - TECHNICAL DEBATE',
};
